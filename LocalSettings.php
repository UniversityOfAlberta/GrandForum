...
$wgRoles = ($config->hasValue('wgRoles')) ? 
    ...
    array(HQP, PS, EXTERNAL, ISAC, IAC, CAC, NCE, AR, CI, RMC, HQPAC, CF, BOD, BODC, CHAMP, PARTNER, GOV, ASD, SD, STAFF, MANAGER, ADMIN);

$wgAllRoles = ($config->hasValue('wgAllRoles')) ? 
    $config->getValue('wgAllRoles') :
    array(HQP, PS, STUDENT, EXTERNAL, ISAC, IAC, CAC, NCE, AR, CI, PL, APL, TL, TC, RMC, HQPAC, EVALUATOR, CF, BOD, BODC, CHAMP, PARTNER, GOV, ASD, SD, STAFF, MANAGER, ADMIN);
