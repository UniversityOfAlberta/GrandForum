(function( $ ){
  $.fn.switcheroo = function(options) {
    ...
    this.init = function(){
        ...
        $("#" + this.id).html("<input type='hidden' value='' name='" + this.id + "' /><table style='display:none'><tr><td colspan='3' style='display:none;width:100px;'></td></tr><tr><td align=\'center\'><b><span class='en'>Current</span>" + this.name.pluralize() + " <span class='fr'>Actuelle</span></b></td><td></td><td><div style='float:right;'><b id='" + this.id + "helpCell'>?</b></div><b><span class='en'>Search/Add</span><span class='fr'>Recherche / Ajouter</span> " + this.name.pluralize() + ":</b><br /><input onKeyPress=\'return disableEnterKey(event)\' id=\'search" + this.id.pluralize() + "\' style=\'width:100%;\' type=\'text\' /></td></tr>" +
