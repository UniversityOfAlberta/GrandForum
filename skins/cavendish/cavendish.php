...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php $this->text('lang') ?>" lang="<?php $this->text('lang') ?>" dir="<?php $this->text('dir') ?>">
	<head>
		...
		<script language="javascript" type="text/javascript" src="<?php echo "$wgServer$wgScriptPath"; ?>/scripts/date.js?<?php echo filemtime('scripts/date.js'); ?>"></script>
...
<div id="container">
    ...
    <div id="outerHeader" class=' <?php if(isset($_COOKIE['sideToggled']) && $_COOKIE['sideToggled'] == 'in') echo "menu-in";?>'>
        ...
        <?php 
            ...
            $GLOBALS['tabs']['Profile'] = TabUtils::createTab("<en>My Profile</en><fr>Mon profil</fr>");
            $GLOBALS['tabs']['Manager'] = TabUtils::createTab("<en>Manager</en><fr>Gérant</fr>");
