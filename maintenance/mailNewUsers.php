...
foreach($lines as $line){
    ...
    if(count($cells) > 1){
        ...
        $message = "<p>Une version française suit ci-dessous.</p>
                    ...
                    <p>Welcome to the CS-Can | Info-Can Forum.</p>
                    ...
                    <p>You can activate your account by going to the login page for the Forum and clicking on the Reset Password button. This will send email to the address associated with your account that will include a custom URL that will allow you to set a password for your user account. Once you have set a password, your account will be active.</p>
                    ...
                    <p>Bienvenue sur le CS-Can | Forum Info-Can.</p>
