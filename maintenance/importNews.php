<?php
    ...
    $json = file_get_contents("https://www.ualberta.ca/api/coveo/search/ualberta-news-feed?category=('Science%20and%20Technology')&news_source=('folio')&count=100");
    ...
    foreach($allPeople as $person){
        foreach($results as $news){
            ...
            $text = "<b>{$title}</b><br />{$description}<br /><a href='{$url}' target='_blank'>Full Story</a>";
