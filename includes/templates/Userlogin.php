...
<form name="userlogin" method="post" action="<?php $this->text('action') ?>">
    <?php global $wgOut; $wgOut->setPageTitle("Log in"); ?>
	...
	<p style="margin-bottom:20px;">Your login ID is a concatenation of your first and last names: First.Last;<br /> 
	If you have forgotten your password please enter your login and ID and request a new random password to be sent to the email address associated with your Forum account.
    </p>
...
<form name="userlogin2" id="userlogin2" method="post" action="<?php $this->text('action') ?>">
	...
	<?php } ?>
		...
		<tr>
			<td class="mw-label"><label for='wpType'>User Type:</label></td>
			<td class="mw-input">
				<input type='radio' name='wpUserType' value='<?php echo PNI; ?>' checked /> Network Investigator<br />
				<input type='radio' name='wpUserType' value='<?php echo CNI; ?>' /> Collaborating Researcher<br />
				<input type='radio' name='wpUserType' value='<?php echo HQP; ?>' /> <?php echo HQP; ?><br />
				<input type='radio' name='wpUserType' value='<?php echo GOV; ?>' /> Government<br />
			</td>
		</tr>
		<tr>
