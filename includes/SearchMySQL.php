...
class SearchMySQL extends SearchEngine {
	...
	function queryRanking( $filteredTerm, $fulltext ) {
		return 'ORDER BY occurrences DESC, page_len DESC';
	}
	...
	function queryMain( $filteredTerm, $fulltext ) {
		...
		return "SELECT page_id, page_namespace, page_title, LENGTH(si_text) - LENGTH(REPLACE(si_text, '$filteredTerm', '')) AS occurrences ".
