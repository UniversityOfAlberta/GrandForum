...
class User {
	...
	//@{
	var $mId, $mName, $mRealName, $mTwitter, $mPassword, $mNewpassword, $mNewpassTime,
	...
	function loadFromRow( $row ) {
		...
		$this->mTwitter = $row->user_twitter;
	 ...
	 * @return \string User's twitter feed
	 */
	function getTwitter() {
		$this->load();
	...
	/**
	 * Set the user's real twitter feed
	 * @param $str \string New twitter feed
	 */
	function setTwitter( $str ) {
		$this->load();
		$this->mTwitter = $str;
	}
