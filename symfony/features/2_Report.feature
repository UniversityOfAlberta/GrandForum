Feature: Reporting
    ...
    Scenario: Checking for edge case html entities 7
        Given I am logged in as "NI.User1" using password "NI.Pass1"
        When I go to "index.php/Special:Report?report=Report"
        And I click "Section 3"
        And I wait until I see "Section 3" in "#reportHeader" up to "1000"
    ...
    Scenario: NI generates and submits the report
        ...
        When I go to "index.php/Special:Report?report=Report"
        And I click "Submit"
        And I wait until I see "Submit" in "#reportHeader" up to "1000"
        Then I should see "Generate a new Report PDF for submission"
        And I press "Generate Report PDF"
        And I wait until I see "PDF Generated Successfully" up to "2000"
