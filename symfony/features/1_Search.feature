Feature: Search
    ...
    Scenario: NI searches for User
        ...
        Then I wait until I see "NI User1" up to "3000"
        And I wait until I see "NI User2" up to "3000"
        And I wait until I see "NI User3" up to "3000"
        
    Scenario: NI searches for a phase 2 Project
        Given I am logged in as "NI.User1" using password "NI.Pass1"
        When I fill in "globalSearchInput" with "Phase 2 Project"
        Then I wait until I see "Phase2Project1" up to "3000"
        And I wait until I see "Phase2Project2" up to "3000"
        And I wait until I see "Phase2BigBetProject1" up to "3000"
        
    Scenario: NI searches for a user with accented characters
        Given I am logged in as "NI.User1" using password "NI.Pass1"
        When I fill in "globalSearchInput" with "User WithAccents"
        Then I wait until I see "Üšër WìthÁççénts" up to "3000"
