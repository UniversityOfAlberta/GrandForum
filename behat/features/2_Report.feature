Feature: Reporting
    ...
    Scenario: HQP edits and saves their report
        ...
        And I fill in "HQPReport_Ia_head_person16_project0_milestone0_OR_person16_project0_milestone0_ProjectLimit_Ia_person16_project0_milestone0_projects_person16_project192_milestone0_Ia" with "lorem ipsum"
        And I press "Save"
    ...
    Scenario: PNI edits one of their HQP's reports
        ...
        And I wait until I see "Excellence of the Research Program: How my research contributes to the Network" up to "5000"
        And I click "Excellence of the Research Program: How my research contributes to the Network"
        And I fill in "HQPReport_Ia_head_person16_project0_milestone0_OR_person16_project0_milestone0_ProjectLimit_Ia_person16_project0_milestone0_projects_person16_project192_milestone0_Ia" with "edited by supervisor"
        And I press "Save"
        And I click "HQP Dashboard"
        And I wait until I see "Projects:" up to "5000"
        And I click by css "#HQPReport"
