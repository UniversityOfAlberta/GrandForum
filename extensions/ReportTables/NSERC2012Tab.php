...
class NSERC2012Tab extends AbstractTab {

    function NSERC2012Tab(){
        global $wgOut;
        parent::AbstractTab("2012");
...
";
        ...
        if(ArrayUtils::get_string($_GET, 'year') == "2012"){
    ...
    function showContentsTable(){
        ...
        $this->html .=<<<EOF
            ...
            <ul>
            <li class='toclevel-1'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Grand'><span class='tocnumber'>4</span> <span class='toctext'>GRAND tables</span></a>
                <ul>
                ...
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table4'><span class='tocnumber'>4.1</span> <span class='toctext'>Table 4: Number of Graduate Students Working on Network Research</span></a></li>
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table4.2'><span class='tocnumber'>4.2</span> <span class='toctext'>Table 4.2: HQP Breakdown by University</span></a></li>
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table4.3'><span class='tocnumber'>4.3</span> <span class='toctext'>Table 4.3: NI Breakdown by University</span></a></li>
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table5'><span class='tocnumber'>4.4</span> <span class='toctext'>Table 5: Post Network employment of graduate students</span></a></li>
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table6'><span class='tocnumber'>4.5</span> <span class='toctext'>Table 6: Dissemination of Network Research Results and Collaborations</span></a></li>
                <li class='toclevel-2'><a href='$wgServer$wgScriptPath/index.php/Special:EvaluationTable?section=NSERC&year=2012&summary=grand#Table7'><span class='tocnumber'>4.6</span> <span class='toctext'>Table 7: Publications list</span></a></li>
                </ul>
            </li>
            </ul>
            </td></tr>
...
EOF;
    ...
    function showGrandTables() {
        ...
        $unique = array();
        $movedons = Person::getAllMovedOnDuring("2011-01-01 00:00:00", "2012-01-01 00:00:00");
        ...
        $papers = Paper::getAllPapersDuring("all", "Publication", "grand", "2011-01-01 00:00:00", "2012-01-01 00:00:00"); //Current Reporting year
        ...
        $this->html .= "<a id='Table4.2'></a><h3>Table 4.2: HQP Breakdown by University</h3>" .self::getHQPUniStats();
    ...
    function getHQPStats(){
        ...
        $hqps = Person::getAllPeopleDuring(HQP,"2011-01-01 00:00:00", "2012-01-01 00:00:00");
        ...
        $papers = Paper::getAllPapersDuring("all", "Publication", "grand", "2011-01-01 00:00:00", "2012-01-01 00:00:00"); 
        foreach($papers as $paper){
            $type = $paper->getType();
            if($type == "PhD Thesis"){
                $pos = "PhD";
...
EOF;
    ...
    function getNIUniStats(){
        ...
        $cnis = Person::getAllPeopleDuring(CNI,"2011-01-01 00:00:00", "2012-01-01 00:00:00");
        $pnis = Person::getAllPeopleDuring(PNI,"2011-01-01 00:00:00", "2012-01-01 00:00:00");
...
EOF;
    ...
    static function showHQPTable(){
        ...
        $people = Person::getAllPeopleDuring(HQP,"2011-01-01 00:00:00", "2012-01-01 00:00:00");
        $chunk = "
...
";
    ...
    function showDisseminations(){
        global $wgOut;
        $publications = Paper::getAllPapersDuring('all', 'Publication', "grand", "2011-01-01 00:00:00", "2012-01-01 00:00:00");
...
EOF;
    ...
    function showArtDisseminations(){
        global $wgOut;
        $publications = Paper::getAllPapersDuring('all', 'Artifact', "grand", "2011-01-01 00:00:00", "2012-01-01 00:00:00");
...
EOF;
    ...
    function showActDisseminations(){
        global $wgOut;
        $publications = Paper::getAllPapersDuring('all', 'Activity', "grand", "2011-01-01 00:00:00", "2012-01-01 00:00:00");
