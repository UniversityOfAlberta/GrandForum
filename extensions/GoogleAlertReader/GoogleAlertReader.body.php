...
class GoogleAlertReader{
	...
	function getNews($action, $article){
		global $wgOut, $wgScriptPath, $wgLocalTZoffset;
		if($action == "getNews"){
			$wgOut->addLink(array("rel" => "alternate", "type" => "application/rss+xml", "title" => "GRAND NCE News", "href" => "http://www.google.com/alerts/feeds/05256187622886684561/9298404980324971668"));
			$wgOut->setPageTitle("GRAND NCE News");
