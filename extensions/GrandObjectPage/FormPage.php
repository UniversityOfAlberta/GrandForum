            ...
            if($edit){
                ...
                foreach($pArray as $project){
                    ...
                    if($project == $projectName){
                        $wgOut->addHTML("<td style='min-width:150px;' valign='top'><input type='radio' name='projects[]' value='$project' checked='checked' /> $project<br /></td>\n");
                    }
                    else {
                        $wgOut->addHTML("<td style='min-width:150px;' valign='top'><input type='radio' name='projects[]' value='$project' /> $project</td>\n");
                    }
                    $i++;
                }
                $wgOut->addHTML("</table>");
