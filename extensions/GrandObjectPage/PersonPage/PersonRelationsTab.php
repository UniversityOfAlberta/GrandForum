                ...
                if($person->isHQP() || ($person->isRole(INACTIVE) && $person->wasLastRole(HQP))){
                    ...
                    if(count($person->getHQP()) > 0){
                        ...
                        foreach($relations as $r){
                            ...
                            if($end_date == 'Current'){
                                $ethics = ($ethics['completed_tutorial'])? "<img style='vertical-align:bottom;' width='40px' src='/skins/cavendish/ethical_button.jpg' />" : "<img style='vertical-align:bottom;' width='40px' src='/skins/cavendish/ethical_button_not.jpg' />";
                            }
                            else{
                                $ethics = "N/A";
                            }
