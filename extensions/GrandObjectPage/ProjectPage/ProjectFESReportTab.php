...
class ProjectFESReportTab extends AbstractEditableTab {
    ...
    function generateBody(){
        ...
        for($y=$today; $y >= $year; $y--){
            ...
            $this->html .= "<h3>Provide a brief description of your research progress dyring FY".($y - $phaseYear)."</h3>
                            {$q1}
    ...
    function generateEditBody(){
        ...
        for($y=$today; $y >= $year; $y--){
            ...
            $this->html .= "<h3><a href='#'>".$y."/".substr($y+1,2,2)."</a></h3>";
            $this->html .= "<div style='overflow: auto;'>";
            $this->html .= "<h3>Provide a brief description of your research progress dyring FY".($y - $phaseYear)." <small>(please focus on scholarly and not administrative activities)(300 words)</small></h3>
