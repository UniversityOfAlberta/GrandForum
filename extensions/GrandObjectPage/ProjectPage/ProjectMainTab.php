        ...
        if($config->getValue('allowPhotoUpload')){
            if($edit){
                ...
                foreach($images as $image){
                    $this->html .= "<a href='{$image}' data-lightbox='images'><img style='max-width:calc(".(100/count($images))."% - 20px);px;max-height:200px;margin:0 auto;border-radius:5px;margin:0 10px;box-sizing:border-box;' src='{$image}' /></a>";
                }
                $this->html .= "</div>";
            }
        }
