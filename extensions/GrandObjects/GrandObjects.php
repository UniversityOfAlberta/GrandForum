...
$apiRequest->addAction('Hidden','person/:id/products/managed/:projectId', 'PersonProductAPI');
...
$apiRequest->addAction('Hidden','limstaskpmm/:id/taskfiles/:file_id', 'LIMSTaskAPIPmm');
