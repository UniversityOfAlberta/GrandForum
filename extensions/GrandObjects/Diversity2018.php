 ...
 */
class Diversity2018 extends BackboneModel {
    ...
    static function newFromId($id){
        $data = DBFunctions::select(array('grand_diversity_2018'),
                                    array('*'),
                                    array('id' => $id));
        $diversity = new Diversity2018($data);
        return $diversity;
    }
    ...
    static function getAllDiversity(){
        ...
        if(count($data) > 0){
            foreach($data as $diversityId){
                $diversity = Diversity2018::newFromId($diversityId['id']);
    ...
    function create(){
        DBFunctions::insert('grand_diversity_2018',
    ...
    function update(){
        DBFunctions::update('grand_diversity_2018',
                            array('user_id' => $this->userId,
                                  'language' => $this->language,
                                  'decline' => $this->decline,
                                  'reason' => $this->reason,
    ...
    function exists(){
        $diversity = Diversity2018::newFromId($this->getId());
