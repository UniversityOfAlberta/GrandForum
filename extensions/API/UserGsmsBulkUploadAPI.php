        ...
        if(isset($xls['type']) &&
            ...
            foreach($data as $student){
                ...
                if($student_id != 0){
                    ...
                    $gsms_sheet->setAdditional("gender", @$student['gender']);
                    $gsms_sheet->setAdditional("date_of_birth", @$student['date_of_birth']);
                    $gsms_sheet->setAdditional("program_name", @$student['program_name']);
                    $gsms_sheet->setAdditional("country_of_birth", @$student['country_of_birth']);
                    $gsms_sheet->setAdditional("country_of_citizenship", @$student['country_of_citizenship']);
                    $gsms_sheet->setAdditional("applicant_type", @$student['applicant_type']);
                    $gsms_sheet->setAdditional("education_history", @$student['education_history']);
                    $gsms_sheet->setAdditional("department", @$student['department']);
                    $gsms_sheet->setAdditional("epl_test", @$student['epl_test']);
                    $gsms_sheet->setAdditional("epl_score", @$student['epl_score']);
                    $gsms_sheet->setAdditional("epl_listen", @$student['epl_listen']);
                    $gsms_sheet->setAdditional("epl_write", @$student['epl_write']);
                    $gsms_sheet->setAdditional("epl_read", @$student['epl_read']);
                    $gsms_sheet->setAdditional("epl_speaking", @$student['epl_speaking']);
                    $gsms_sheet->setAdditional("cs_app", @$student['cs_app']);
                    $gsms_sheet->setAdditional("academic_year", @$student['academic_year']);
                    $gsms_sheet->setAdditional("term", @$student['term']);
                    $gsms_sheet->setAdditional("subplan_name", @$student['subplan_name']);
                    $gsms_sheet->setAdditional("program", @$student['program']);
                    $gsms_sheet->setAdditional("degree_code", @$student['degree_code']);
                    $gsms_sheet->setAdditional("admission_program_name", @$student['admission_program_name']);
                    $gsms_sheet->setAdditional("folder", @$student['folder']);
                    $gsms_sheet->setAdditional("department_gpa", @$student['department_gpa']);
                    $gsms_sheet->setAdditional("department_gpa_scale", @$student['department_gpa_scale']);
                    $gsms_sheet->setAdditional("department_normalized_gpa", @$student['department_normalized_gpa']);
                    $gsms_sheet->setAdditional("fgsr_gpa", @$student['fgsr_gpa']);
                    $gsms_sheet->setAdditional("fgsr_gpa_scale", @$student['fgsr_gpa_scale']);
                    $gsms_sheet->setAdditional("fgsr_normalized_gpa", @$student['fgsr_normalized_gpa']);
                    $gsms_sheet->setAdditional("funding_note", @$student['funding_note']);
                    $gsms_sheet->setAdditional("department_decision", @$student['department_decision']);
                    $gsms_sheet->setAdditional("fgsr_decision", @$student['fgsr_decision']);
                    $gsms_sheet->setAdditional("decision_response", @$student['decision_response']);
                    $gsms_sheet->setAdditional("general_notes", @$student['general_notes']);
