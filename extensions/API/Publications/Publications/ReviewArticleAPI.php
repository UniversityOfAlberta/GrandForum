...
class ReviewArticleAPI extends PaperAPI{
	
	function ReviewArticleAPI($update=false){
	    parent::PaperAPI($update, "Review Article", "Publication");
	    ...
	    $this->addPOST("published_in",false,"The publication in which the review appears","My Magazine of Review Articles");
