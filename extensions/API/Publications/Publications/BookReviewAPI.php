...
class BookReviewAPI extends PaperAPI{
	
	function BookReviewAPI($update=false){
	    parent::PaperAPI($update, "Book Review", "Publication");
	    ...
	    $this->addPOST("book_title",false,"The title of the book being reviewed", "My Book");
	    $this->addPOST("published_in",false,"The publication in which the review appears","My Magazine of Book Reviews");
