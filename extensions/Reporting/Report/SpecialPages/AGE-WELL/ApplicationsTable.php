...
class ApplicationsTable extends SpecialPage{
    ...
    function generateProject(){
        ...
        $tabbedPage->addTab(new ApplicationTab('RP_CRP_PPP_REPORT', $this->projects, 2023, "CRP-PPP Mid-Year 2023"));
        $tabbedPage->addTab(new ApplicationTab('RP_CRP_PPP_REPORT', $this->projects, 2022, "CRP-PPP Mid-Year 2022"));
