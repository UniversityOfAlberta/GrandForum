...
class StringReportItemSet extends ReportItemSet {
    ...
    function getData(){
        ...
        $array6 = explode("|", str_replace('\|', '&vert;', $this->getAttr("array6")));
        ...
        foreach($array as $key => $el){
            ...
            if(isset($labels[$key])){
                ...
                $tuple['extra'] = array('label' => $labels[$key], 
                                        ...
                                        'value6' => @trim(str_replace('&vert;', '|', $array6[$key])));
            }
            else if(count($array2) > 1 || count($array3) > 1 || count($array4) > 1 || count($array5) > 1 || count($array6) > 1){
