...
define("REPORTING_YEAR_REAL", 2014); // Hard-coded year for the reporting period
...
define("REPORTING_RMC_REVISED_MONTH", '-02-20');
define("REPORTING_RMC_MEETING_MONTH", '-02-28');
