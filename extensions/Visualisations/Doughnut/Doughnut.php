...
class Doughnut extends Visualisation {
    ...
    static function init(){
        ...
        $wgOut->addScript('<script src="'.$wgServer.$wgScriptPath.'/extensions/Visualisations/Doughnut/doughnut/popup.js" type="text/javascript" charset="utf-8"></script>');
        ...
        $wgOut->addScript('<script src="'.$wgServer.$wgScriptPath.'/extensions/Visualisations/Doughnut/doughnut/doughnut.js" type="text/javascript" charset="utf-8"></script>');
    }
