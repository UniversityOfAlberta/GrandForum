...
class PeopleWikiTab extends AbstractTab {
	...
	if(in_array($this->table, $resources)){
        ...
        $this->html .= "<br />
                    <div style='font-size: 1.5em;'><span class='en'>Below are all the <b>{$this->table}</b> Files in {$config->getValue('networkName')}.  To search for a file or page in particular, use the search box below.  You can search by name, date last edited, and last editor.<br /><br />
